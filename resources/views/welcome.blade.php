<x-guest-layout>
    ...
    <div>
        <form method="POST" action="{{ route('register.cliente') }}">
            ...
            <p class="text-center mb-4 dark:text-white">Datos cliente</p>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="celular" class="block mt-1 w-full" type="text" name="celular" :value="old('celular')" required autofocus autocomplete="celular" maxlength="15" oninput="this.value = this.value.replace(/[^0-9]/g, '')" />
